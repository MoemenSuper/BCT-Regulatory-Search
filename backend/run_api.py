...
def main() -> None:
    ...
    parser.add_argument("--enable-graph", action="store_true", help="Enable Graph Lite runtime retrieval")
    ...
    os.environ["BCT_ENABLE_GRAPH"] = "1" if args.enable_graph else os.environ.get("BCT_ENABLE_GRAPH", "0")
