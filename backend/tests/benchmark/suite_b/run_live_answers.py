...
_MUST_TOUCH_ALIASES = {
    ...
    "fiche technique": ("fiche technique", "technical", "certificate"),
    "publication": (
        "publication",
        "publiee",
        "publiée",
    ...
    "traite": ("traite", "traite ", "سفتجة"),
    "avalisee": ("avalisee", "avalisée", "avalise", "aval"),
    ...
    "exceptions": ("exceptions", "exclues", "exclue", "exclusion", "exempt"),
    "conditions": (
        "conditions",
        "condition",
        "sous reserve",
    ...
    "autorisation": ("autorisation", "autorisee", "autorisée", "autoriser", "préalable", "prealable"),
    "independamment": (
        "independamment",
        "indépendamment",
        "quel que soit",
    ...
    "remise documentaire": ("remise documentaire", "remises documentaires", "documentary collection"),
    "fonds propres": ("fonds propres", "fond propres", "own funds", "numeraire", "numéraire"),
    "numeraire": ("numeraire", "numéraire", "cash", "espèces", "especes"),
    "cash": ("cash", "numeraire", "numéraire", "espèces", "especes", "depot", "dépôt"),
    "deposit": ("deposit", "depot", "dépôt", "depots", "dépôts", "numeraire", "numéraire"),
    "documentary": ("documentary", "documentaire", "credit documentaire", "crédit documentaire"),
    "librement": ("librement", "libre", "sans autorisation", "free settlement"),
    "industrielles": (
        "industrielles",
        "industrielle",
        "industriel",
    ...
    "non prioritaires": ("non prioritaires", "non prioritaire", "non-prioritaires", "non-priority"),
    "entamee": ("entamee", "entamée", "entame", "entamé", "execution", "exécution", "commence"),
    "prealablement": ("prealablement", "préalablement", "avant", "deja engage", "déjà engagé"),
    "execution": ("execution", "exécution", "entamee", "entamée", "commence", "engage"),
