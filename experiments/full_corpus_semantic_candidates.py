    ...
    *,
    ...
    result = {
        ...
        "failure_distribution": {
            ...
            "legal_action_candidates_with_unresolved_targets": legal_actions,
            "legal_action_candidates_without_visual_verification": legal_actions,
            "replacement_candidates_with_unverified_predecessor_text": (
